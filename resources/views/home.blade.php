...
<div class="hero-wrap js-fullheight" style="margin-top: 0px; background-image: url({{ asset('assets/images/image_2.jpg') }});">
                      ...
                      <div class="half left-arrow d-flex align-items-center">
                          <div class="text p-4 p-xl-5 text-center">
                              ...
                              <ul class="list-accomodation">
                                  <li><span>Max:</span> {{  $room->max_per }}</li>
                                  <li><span>Size:</span> {{  $room->size }} m&sup2;</li>
